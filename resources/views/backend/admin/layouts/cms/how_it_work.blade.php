                ...
                <form id="kt_modal_new_target_form" class="form" method="POST"   enctype="multipart/form-data">
                    ...
                    <div class="row g-9 mb-8">
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Work Title</label>
                    ...
                    <div class="row g-9 mb-8">
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Title1</label>
                    ...
                    <div class="row g-9 mb-8">
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Title2</label>
                    ...
                    <div class="row g-9 mb-8">
                        <div class="col-md-6 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Title3</label>
        ...
        <table class="table align-middle table-row-bordered table-row-solid gy-4 gs-9 data-table">
            ...
            <thead class="border-gray-200 fs-5 fw-semibold bg-lighten m-3">
                <tr>
                    ...
                    <th class="min-w-150px px-0">Work Title</th>
                    <th class="min-w-350px">Title1</th>
                    <th class="min-w-125px">Description1</th>
                    <th class="min-w-125px">Title2</th>
                    <th class="min-w-125px">Description2</th>
                    <th class="min-w-125px">Title3</th>
...
<script>
 $(document).ready(function () {
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{route('howitwork') }}", // Ensure this route is correct
                type: 'GET'
            },
            columns: [
                { data: 'id', name: 'id' },
