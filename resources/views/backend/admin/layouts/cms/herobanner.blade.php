                ...
                <form id="kt_modal_new_target_form" class="form" method="POST"   enctype="multipart/form-data">
                    ...
                    <div class="row g-9 mb-8">
                        <div class="col-md-12 fv-row">
                           ...
                           <input type="text" name="title" id="title" rows="3" required placeholder="Enter Your title"  class="form-control form-control-solid">
                        </div>
                    </div>
                    ...
                    <div class="row g-9 mb-8">
                        <div class="col-md-12 fv-row">
                           ...
                           <input type="text" name="description" id="description" rows="3" required placeholder="Enter Your title" class="form-control form-control-solid">
                        </div>
                    </div>
                    ...
                    <div class="row g-9 mb-8">
                        <div class="col-md-12 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Button Name</label>
                           <input type="text" name="button" id="button" rows="3" required placeholder="Enter Your title" class="form-control form-control-solid">
                        </div>
                    </div>
                
                    <div class="text-center">
                        <button type="reset" id="kt_modal_new_target_cancel" class="btn btn-light me-3">Cancel</button>
                        <button type="submit" id="kt_modal_new_target_submit" class="btn btn-primary">Add Banner</button>
                    </div>
                </form>
            ...
            <table class="table align-middle table-row-bordered table-row-solid gy-4 gs-9 data-table">
                ...
                <thead class="border-gray-200 fs-5 fw-semibold bg-lighten m-3">
                    <tr>
                        ...
                        <th class="min-w-150px px-0">Section</th>
...
<script>
    ...
    $(document).ready(function () {
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{route('banner') }}", // Ensure this route is correct
                type: 'GET'
            },
            columns: [
                { data: 'id', name: 'id' },
