                ...
                <form id="kt_modal_new_target_form" class="form" action="" method="POST">
                    ...
                    <!--end::Input group-->
                     ...
                     <div class="d-flex flex-column mb-8">
                        ...
                        <select class="form-select form-select-solid" data-control="select1" data-hide-search="true" data-placeholder="Select Question Type" name="target_assign" name="vehicle_issue" id="vehicle_issue">
                            <option value="" selected disabled>Select status</option>
                        <option value="Engine Issue">Active</option>
                        <option value="Transmission Problem">Inactive</option>
